...
if __name__ == "__main__":
    ...
    parser.add_argument('-v','--video-folder', default = VIDEO_FOLDER, help='The folder where the videos are saved.', required=True)
    ...
    extract_video_frames(len(list(filter(lambda filename : any(ext in filename for ext in formats), os.listdir(VIDEO_FOLDER)))))
